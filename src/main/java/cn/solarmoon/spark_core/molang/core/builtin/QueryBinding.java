...
//        var("head_y_rotation", ctx -> ctx.data().headPitch);
        ...
        entityVar("eye_target_x_rotation", ctx -> ctx.entity().getViewXRot(ctx.getPartialTick()));
        entityVar("eye_target_y_rotation", ctx -> ctx.entity().getViewYRot(ctx.getPartialTick()));
        ...
        livingEntityVar("body_x_rotation", ctx -> Mth.lerp(ctx.getPartialTick(), ctx.entity().xRotO, ctx.entity().getXRot()));
        livingEntityVar("body_y_rotation", ctx -> Mth.wrapDegrees(Mth.lerp(ctx.getPartialTick(), ctx.entity().yBodyRotO, ctx.entity().yBodyRot)));
