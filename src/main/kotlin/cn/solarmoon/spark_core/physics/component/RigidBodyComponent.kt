...
class RigidBodyComponent(
    ...
    authority: Authority,
    level: Level,
): AbstractRigidBodyComponent<PhysicsRigidBody>(
    name, authority, level, SparkDiffSyncSchemas.RIGID_BODY_DATA.get(), SparkCollisionObjectTypes.RIGID_BODY.get(), PhysicsRigidBody(BoxCollisionShape(0F))
) {
