...
object JSPhysicsHelper {

    fun createCollisionBoxBoundToBone(animatable: IAnimatable<*>, boneName: String, size: Value, offset: Value) = createCollisionBoxBoundToBone(animatable, boneName, size, offset, null)

    fun createCollisionBoxBoundToBone(animatable: IAnimatable<*>, boneName: String, size: Value, offset: Value, init: Value?): PhysicsCollisionObject {
