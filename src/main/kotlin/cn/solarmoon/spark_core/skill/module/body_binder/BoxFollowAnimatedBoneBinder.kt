...
class BoxFollowAnimatedBoneBinder(
    ...
    override val shape: CollisionShape = CompoundCollisionShape().apply { addChildShape(BoxCollisionShape(size.div(2f, Vector3f()).toBVector3f()), offset.toBVector3f()) }
    ...
    override fun copy(): RigidBodyBinder {
        return BoxFollowAnimatedBoneBinder(boneName, size, offset, activeTime)
    }
